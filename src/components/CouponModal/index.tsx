                ...
                <View style={styles.content}>
                    <View style={styles.header}>
                        ...
                        <View style={styles.headerTitleRow}>
                            <Text style={styles.title}>{isGiftCard ? 'Gift Cards' : 'Coupons & Offers'}</Text>
                    ...
                    <View style={styles.manualEntryContainer}>
                        ...
                        <TouchableOpacity
                            ...
                            disabled={!manualCode}
                        >
                            <Text style={[styles.applyAction, !manualCode && styles.applyActionDisabled]}>APPLY</Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    <FlatList
                        ...
                        ListEmptyComponent={
                            <View style={styles.emptyContainer}>
                                <AppIcons.ShoppingCart color="#DDD" size={64} />
