import { View, Text, Image, ScrollView, TouchableOpacity, TextInput, ActivityIndicator, Alert, ImageBackground, Modal } from 'react-native';
        ...
        <SafeAreaView style={styles.mainContainer}>
            ...
            <View style={styles.innerContainer}>
                <View style={{ flex: 1 }}>
                    ...
                    {showHistoryNote && (
                        <View style={[styles.historyNoteContainer, { marginHorizontal: wp('5%'), marginBottom: 10 }]}>
                ...
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContainer}>
                        ...
                        <View style={{ paddingHorizontal: wp('5%') }}>
                            ...
                            <Text style={[styles.availableBalanceHeaderText, { marginTop: 20 }]}>Preferred Method</Text>
                            ...
                            <TouchableOpacity
                                ...
                                style={[styles.redeemButton, { marginTop: 30, width: '100%', marginBottom: 20 }]}
                            >
                                {isRedeeming ? (
            ...
            >
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContainer}>
                        ...
                        <ScrollView>
                            {isLoadingHistory ? (
                                <ActivityIndicator size="large" color={colors.themeTeal} style={{ marginTop: 30 }} />
