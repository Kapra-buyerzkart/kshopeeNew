...
import { View, Text, Modal, TouchableOpacity, ScrollView, FlatList, TouchableWithoutFeedback, Image } from 'react-native';
...
const FilterModal: React.FC<FilterModalProps> = ({ visible, onClose, onApply, categoryName, categoryImage }) => {
        ...
        return (
            ...
            >
                <View style={[styles.checkbox, isSelected && styles.checkboxActive]}>
                    {isSelected && <Ionicons name="checkmark" size={16} color={colors.themeTeal} />}
                </View>
                    ...
                    <TouchableWithoutFeedback>
                        <View style={styles.modalContainer}>
                            ...
                            <View style={styles.modalCategoryProfile}>
                                {categoryImage && <Image source={categoryImage} style={styles.modalCategoryImage} />}
                            ...
                            <View style={styles.modalHeader}>
                                <View style={styles.modalHeaderLeft}>
                                    <Ionicons name="options-outline" size={20} color={colors.themeBlack} onPress={onClose} />
                                    <Text style={styles.modalTitle}>Filter</Text>
                                </View>
                                <Ionicons name="funnel-outline" size={20} color={colors.themeBlack} />
                            </View>
                            ...
                            <View style={styles.modalBody}>
                                            ...
                                            >
                                                ...
                                                {(count > 0 && !isActive) && (
                                                    <View style={styles.modalTabBadge}>
                                                        <Text style={styles.modalTabBadgeText}>{count}</Text>
                                                    </View>
                                                )}
                                            </TouchableOpacity>
                                        );
                                ...
                                <View style={styles.modalContent}>
                                    <FlatList
                                        data={filterOptions[activeTab as keyof typeof filterOptions] || []}
                            ...
                            <View style={styles.modalFooter}>
                                <TouchableOpacity style={styles.resetBtn} onPress={handleReset}>
                                    <Ionicons name="refresh-outline" size={20} color={colors.themeBlack} />
